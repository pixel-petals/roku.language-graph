 ...
 *
 * Parsing (src/parse/roku-app) and storage (src/db) now live in the
 ...
 *
 * TODO: once src/db/sqlite has a real implementation, read its graph
...
export default function crgAdapter(_options: PluginOptions = {}): never {
  throw new Error('not implemented — pending src/db/sqlite');
}
